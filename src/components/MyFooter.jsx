const MyFooter = () => (
    ...
    <footer>
      <div class="row justify-content-center pt-5 bg">
        <div class="col col-6">
          <div class="row">
            <div class="col mb-2">
              <i class="bi bi-facebook footer-icon me-2 text-secondary"></i>
              <i class="bi bi-instagram footer-icon me-2 text-secondary"></i>
              <i class="bi bi-twitter-x footer-icon me-2 text-secondary"></i>
          ...
          <div class="row">
            <div class="col mb-2">
              <button type="button" 
                class="btn btn-sm footer-button rounded-0 mt-3 text-secondary border border-secondary">
                Service Code
              </button>
            </div>
          </div>
          <div>
            <div class="mb-2 mt-2 copyright">© 1997-2023 Netflix, Inc.</div>
          </div>
        </div>
      </div>
    </footer>
